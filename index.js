...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6282153218411@s.whatsapp.net`]
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 zaraw bot シ︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 zaraw bot シ︎"
    }
  }, {quoted: freply})
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 zaraw bot シ︎', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 zaraw bot シ︎`, [
            {              
